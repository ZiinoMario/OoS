...
public class Payment extends Transaction {
     ...
     */
    public Payment(String dat, double am, String des) throws TransactionAttributeException {
        super(dat, am, des);
     ...
     */
    public Payment(String dat, double am, String des, double incInt, double outInt) throws TransactionAttributeException {
        this(dat,am,des);
