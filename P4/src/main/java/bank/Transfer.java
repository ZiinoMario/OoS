...
public class Transfer extends Transaction {
    ...
    public void setAmount(double a) throws TransactionAttributeException {
        if(a < 0) { // Test ob Wert unter 0€
            throw new TransactionAttributeException(a);
        } else {
            amount = a;
        }
    }
     ...
     */
    public Transfer(String dat, double am, String des) throws TransactionAttributeException {
        super(dat, am, des);
        setSender("Sender");
     ...
     * @param rec Empfänger
     */
    public Transfer(String dat, double am, String des, String sen, String rec) throws TransactionAttributeException {
        this(dat,am,des);
        setRecipient(rec);
        setSender(sen);
    }
